...
@Component({
  selector: 'app-biocell-channels',
  templateUrl: './biocell-channels.page.html',
  styleUrls: ['./biocell-channels.page.scss'],
})
export class BiocellChannelsPage implements OnInit {
