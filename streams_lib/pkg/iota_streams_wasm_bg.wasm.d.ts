...
export function __wbg_encryptedstate_free(a: number): void;
...
export function channelreader_export_to_bytes(a: number, b: number, c: number): number;
export function channelreader_import_from_bytes(a: number, b: number, c: number, d: number, e: number): number;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc6a2a95b125e8ecc(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h235afcbb6dfb8d07(a: number, b: number, c: number, d: number): void;
